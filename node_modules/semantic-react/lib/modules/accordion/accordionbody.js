 ...
 */
var AccordionBody = (_temp = _class = function (_React$PureComponent) {
    _inherits(AccordionBody, _React$PureComponent);

    function AccordionBody() {
        _classCallCheck(this, AccordionBody);

        return _possibleConstructorReturn(this, (AccordionBody.__proto__ || Object.getPrototypeOf(AccordionBody)).apply(this, arguments));
    }
    ...
    _createClass(AccordionBody, [{
        ...
        value: function render() {
            var _props = this.props,
                ...
                other = _objectWithoutProperties(_props, ['component', 'children', 'defaultClasses', 'active', 'styled']);
