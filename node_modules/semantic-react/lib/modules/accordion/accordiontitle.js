 ...
 */
var AccordionTitle = (_temp2 = _class = function (_React$PureComponent) {
    _inherits(AccordionTitle, _React$PureComponent);
    ...
    function AccordionTitle() {
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = AccordionTitle.__proto__ || Object.getPrototypeOf(AccordionTitle)).call.apply(_ref, [this].concat(args))), _this), _this.onClick = function (event) {
    ...
    _createClass(AccordionTitle, [{
        ...
        value: function render() {
            var _props = this.props,
                ...
                other = _objectWithoutProperties(_props, ['component', 'children', 'defaultClasses', 'active', 'icon', 'iconComponent', 'index', 'onClick']);
            ...
            return _react2.default.createElement(
                Component,
                _extends({}, other, { onClick: this.onClick }),
