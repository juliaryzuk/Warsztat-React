...
var MyBlurringDimmer = function (_React$Component) {
    _inherits(MyBlurringDimmer, _React$Component);

    function MyBlurringDimmer() {
        _classCallCheck(this, MyBlurringDimmer);

        var _this = _possibleConstructorReturn(this, (MyBlurringDimmer.__proto__ || Object.getPrototypeOf(MyBlurringDimmer)).call(this));
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    _segment2.default,
                    { component: _dimmable2.default, dimmed: this.state.dimmed, blurring: true },
                    _react2.default.createElement(
                        _header2.default,
                        { size: 'medium' },
                        'Overlayable section'
                    ...
                    _react2.default.createElement(
                        _dimmer2.default,
                        { active: this.state.dimmed, inverted: this.state.inverted },
                ...
                _react2.default.createElement(
                    _button2.default,
                    { onClick: function onClick() {
                            return _this2.setState({ inverted: !_this2.state.inverted });
                        } },
                    'Toggle dimmer inverting'
                )
            );
        }
    }]);

    return MyBlurringDimmer;
}(_react2.default.Component);

_react2.default.createElement(MyBlurringDimmer, null);
//# sourceMappingURL=blurring.js.map