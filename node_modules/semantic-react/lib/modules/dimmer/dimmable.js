 ...
 */
var Dimmable = (_temp = _class = function (_React$PureComponent) {
    _inherits(Dimmable, _React$PureComponent);

    function Dimmable() {
        _classCallCheck(this, Dimmable);

        return _possibleConstructorReturn(this, (Dimmable.__proto__ || Object.getPrototypeOf(Dimmable)).apply(this, arguments));
    }
    ...
    _createClass(Dimmable, [{
        ...
        value: function render() {
            var _props = this.props,
                ...
                blurring = _props.blurring,
                other = _objectWithoutProperties(_props, ['component', 'defaultClasses', 'dimmed', 'blurring']);
