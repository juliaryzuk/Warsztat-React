 ...
 */
var Detail = (_temp = _class = function (_React$PureComponent) {
    _inherits(Detail, _React$PureComponent);
    ...
    _createClass(Detail, [{
        ...
        value: function render() {
            var _props = this.props,
                ...
                other = _objectWithoutProperties(_props, ['component', 'children', 'defaultClasses']);

            var Component = component;
            other.className = (0, _classnames2.default)(other.className, { detail: defaultClasses });
