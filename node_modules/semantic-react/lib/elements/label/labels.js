 ...
 */
var Labels = (_temp = _class = function (_React$PureComponent) {
    _inherits(Labels, _React$PureComponent);

    function Labels() {
        _classCallCheck(this, Labels);

        return _possibleConstructorReturn(this, (Labels.__proto__ || Object.getPrototypeOf(Labels)).apply(this, arguments));
    }
    ...
    _createClass(Labels, [{
        ...
        value: function render() {
            var _props = this.props,
                ...
                tag = _props.tag,
                size = _props.size,
                other = _objectWithoutProperties(_props, ['component', 'children', 'defaultClasses', 'circular', 'color', 'tag', 'size']);
