...
var Flag = (_temp = _class = function (_React$PureComponent) {
    _inherits(Flag, _React$PureComponent);
    ...
    _createClass(Flag, [{
        ...
        value: function render() {
            var _props = this.props,
                ...
                name = _props.name,
                other = _objectWithoutProperties(_props, ['component', 'defaultClasses', 'name']);
