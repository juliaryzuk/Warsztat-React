...
var Meta = (_temp = _class = function (_React$PureComponent) {
    ...
    _createClass(Meta, [{
        ...
        value: function render() {
            var _props = this.props,
                ...
                other = _objectWithoutProperties(_props, ['children', 'className', 'component', 'defaultClasses']);

            other.className = (0, _classnames2.default)(className, { meta: true });
