...
var MyInputWithButton = function (_React$Component) {
    ...
    function MyInputWithButton() {
        ...
        var _this = _possibleConstructorReturn(this, (MyInputWithButton.__proto__ || Object.getPrototypeOf(MyInputWithButton)).call(this));

        _this.onButtonClick = function () {
            _this.setState({
                send: !_this.state.send,
                sendValue: _this.state.value
            });
        };
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(_input2.default, { actionComponent: function actionComponent() {
                            return _react2.default.createElement(
                                _button2.default,
                                { emphasis: 'primary', onClick: _this2.onButtonClick },
