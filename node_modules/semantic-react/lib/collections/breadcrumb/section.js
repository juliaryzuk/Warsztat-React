 ...
 * Breadcrumb section
 */
var BreadcrumbSection = (_temp = _class = function (_React$PureComponent) {
    _inherits(BreadcrumbSection, _React$PureComponent);

    function BreadcrumbSection() {
        _classCallCheck(this, BreadcrumbSection);

        return _possibleConstructorReturn(this, (BreadcrumbSection.__proto__ || Object.getPrototypeOf(BreadcrumbSection)).apply(this, arguments));
    }
    ...
    _createClass(BreadcrumbSection, [{
        ...
        value: function render() {
            var _props = this.props,
                ...
                other = _objectWithoutProperties(_props, ['component', 'defaultClasses', 'active']);
